 ...
 * <br>
 * @author 葛晓鹏
 * @create time：2014-11-21 下午4:46:10
 * @version: v2.1
 * 
 *       Date              Author      Version     Description
 * ------------------------------------------------------------------
 * 2014-11-21 下午4:46:10 |葛晓鹏    　　|v2.1        |Create
 * 
 */
public class ZipUtil2 {
	public static void main(String[] args) throws IOException {  
		String s="ossgqNSVoMi1bi8iKUs-gt7nSQnFWQSJ8cf5nibCPHNddXnwAmBd5CXZMPVv2u9clNFtdYqIzJf6GFPEqehowK5-Z4G6X1pLdYFVQWgQuDO";
...
//		str="少打飞机拉丝机东方丽景阿斯蒂芬进来撒多了几分网0额哦鈤304583045830945sldfjsflasdfjlasdfj9w03r502385撒旦法连接速度放路径是落地计费是落地计费拉萨京东方拉撒都计费";
//		System.out.println("\n原始的字符串为------->" + str);  
